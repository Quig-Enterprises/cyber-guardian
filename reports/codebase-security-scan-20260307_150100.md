...
### 264 Critical Issues Require Immediate Attention
...
#### 55. Hardcoded credentials detected
...
#### 68. Hardcoded credential or API key detected

**File:** `/var/www/html/wordpress/wp-content/plugins/wordfence/modules/login-security/js/login.1766263234.js:77`
**CWE:** CWE-798
**Confidence:** HIGH
...
#### 122. Hardcoded credentials detected
...
#### 148. File upload without malware scanning detected
...
#### 149. Hardcoded credentials detected
...
#### 150. File upload without malware scanning detected
...
#### 151. File upload without malware scanning detected
...
#### 152. File upload without malware scanning detected
...
#### 153. File upload without malware scanning detected
...
#### 156. Hardcoded credentials detected
...
#### 157. Hardcoded credentials detected
...
#### 159. Hardcoded credentials detected
...
#### 160. File upload without malware scanning detected
...
#### 165. File upload without malware scanning detected
...
#### 169. Deprecated mysql_query() with variable input
...
#### 170. Hardcoded credentials detected
...
#### 175. Hardcoded credential or API key detected

**File:** `/var/www/html/wordpress/wp-content/plugins/jetpack/_inc/blocks/editor-assets/mapbox-gl-1.13.0.js:31`
**CWE:** CWE-798
**Confidence:** HIGH
...
#### 176. Hardcoded credential or API key detected

**File:** `/var/www/html/wordpress/wp-content/plugins/jetpack/_inc/blocks/subscriptions/view.js:1`
**CWE:** CWE-798
**Confidence:** HIGH
...
#### 177. Hardcoded credential or API key detected

**File:** `/var/www/html/wordpress/wp-content/plugins/jetpack/_inc/blocks/recurring-payments/view.js:1`
**CWE:** CWE-798
**Confidence:** HIGH
...
#### 178. Hardcoded credential or API key detected

**File:** `/var/www/html/wordpress/wp-content/plugins/jetpack/_inc/blocks/donations/view.js:2`
**CWE:** CWE-798
**Confidence:** HIGH
...
#### 182. Hardcoded credentials detected
...
#### 205. Possible SQL injection: $wpdb method called with string concatenation instead of prepare()
...
#### 206. Possible SQL injection: $wpdb method called with string concatenation instead of prepare()
...
#### 219. Deprecated mysql_query() with variable input
...
#### 221. Hardcoded credentials detected
...
#### 222. Hardcoded credentials detected
...
#### 223. Hardcoded credentials detected
...
#### 224. Hardcoded credentials detected
...
#### 225. Hardcoded credentials detected
...
#### 226. Hardcoded credentials detected
...
#### 227. Hardcoded credentials detected
...
#### 228. Hardcoded credentials detected
...
#### 232. Hardcoded credentials detected
...
#### 234. Hardcoded credentials detected
...
#### 235. Hardcoded credentials detected
...
#### 236. Hardcoded credentials detected
...
#### 237. Hardcoded credentials detected
...
#### 238. Hardcoded credentials detected
...
#### 239. File upload without malware scanning detected
...
#### 245. Possible SQL injection: $wpdb method called with string concatenation instead of prepare()
...
#### 247. Possible SQL injection: $wpdb method called with string concatenation instead of prepare()
...
#### 252. File upload without malware scanning detected
...
#### 253. Hardcoded credential or API key detected

**File:** `/var/www/html/wordpress/wp-content/plugins/gravityforms/includes/webapi/js/gfwebapi_settings.js:37`
**CWE:** CWE-798
**Confidence:** HIGH
...
#### 255. Hardcoded credentials detected
...
#### 256. Hardcoded credentials detected
...
#### 257. Hardcoded credentials detected
...
#### 258. Hardcoded credentials detected
...
#### 261. Hardcoded credentials detected
...
#### 263. Deprecated mysql_query() with variable input
...
#### 264. Hardcoded credential or API key detected
...
|---------|-------|--------|----------|------|--------|-----|
| woocommerce | 3589 | 156 | 70 | 34 | 1 | 51 |
| jetpack | 1553 | 96 | 10 | 32 | 0 | 54 |
| wordfence | 403 | 76 | 58 | 2 | 0 | 16 |
| the-events-calendar | 1806 | 55 | 8 | 0 | 0 | 47 |
| wpforms | 1268 | 49 | 7 | 25 | 0 | 17 |
| cxq-facebot | 314 | 46 | 30 | 1 | 0 | 15 |
| worker | 316 | 45 | 11 | 0 | 0 | 34 |
| gravityforms | 367 | 45 | 15 | 15 | 0 | 15 |
| archive | 537 | 39 | 1 | 3 | 0 | 35 |
| wpforms-lite | 3659 | 36 | 2 | 16 | 0 | 18 |
| all-in-one-seo-pack-pro | 529 | 34 | 2 | 0 | 0 | 32 |
| motopress-hotel-booking | 1130 | 28 | 0 | 10 | 0 | 18 |
| cxq-signage | 51 | 22 | 18 | 0 | 0 | 4 |
...
| cxq-site-manager-host | 260 | 13 | 3 | 0 | 0 | 10 |
| google-analytics-for-wordpress | 225 | 12 | 3 | 3 | 1 | 5 |
| cxq-scheduler | 234 | 12 | 2 | 0 | 0 | 10 |
| cxq-updater-host | 19 | 11 | 1 | 0 | 0 | 10 |
| cxq-firewall | 228 | 10 | 0 | 0 | 0 | 10 |
| cxq-email-relay | 233 | 9 | 3 | 0 | 0 | 6 |
| cxq-membership | 448 | 9 | 0 | 0 | 0 | 9 |
| hestia-automation | 39 | 9 | 0 | 2 | 0 | 7 |
| woocommerce-product-vendors | 368 | 8 | 7 | 1 | 0 | 0 |
| cxq-google-hours | 240 | 8 | 0 | 0 | 0 | 8 |
| woocommerce-payments | 387 | 8 | 0 | 0 | 0 | 8 |
| antispam-bee | 6 | 8 | 1 | 0 | 0 | 7 |
| cxq-antispam | 260 | 8 | 0 | 0 | 0 | 8 |
| cxq-board-docs | 231 | 6 | 0 | 0 | 0 | 6 |
| cxq-event-calendar | 264 | 6 | 0 | 0 | 0 | 6 |
| wp-mail-smtp | 443 | 5 | 4 | 0 | 0 | 1 |
| distributor | 33 | 5 | 0 | 0 | 0 | 5 |
| finance-manager | 5916 | 5 | 0 | 5 | 0 | 0 |
...
| cxq-site-manager-client | 94 | 3 | 0 | 0 | 0 | 3 |
...
| cxq-spec-auditor | 7 | 1 | 1 | 0 | 0 | 0 |
| cxq-doc-builder | 19 | 1 | 0 | 0 | 0 | 1 |
| cxq-woocommerce-places | 21 | 1 | 1 | 0 | 0 | 0 |
